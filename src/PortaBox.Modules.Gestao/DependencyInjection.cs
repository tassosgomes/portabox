...
public static class DependencyInjection
{
    public static IServiceCollection AddPortaBoxModuleGestao(this IServiceCollection services, IConfiguration? configuration = null)
    {
        ...
        services.AddScoped<IValidator<CreateBlocoCommand>, CreateBlocoCommandValidator>();
        services.AddScoped<IValidator<RenameBlocoCommand>, RenameBlocoCommandValidator>();
        services.AddScoped<IValidator<InativarBlocoCommand>, InativarBlocoCommandValidator>();
        services.AddScoped<IValidator<ReativarBlocoCommand>, ReativarBlocoCommandValidator>();
        services.AddScoped<IValidator<CreateUnidadeCommand>, CreateUnidadeCommandValidator>();
        services.AddScoped<IValidator<InativarUnidadeCommand>, InativarUnidadeCommandValidator>();
        services.AddScoped<IValidator<ReativarUnidadeCommand>, ReativarUnidadeCommandValidator>();
        ...
        services.AddScoped<ICommandHandler<CreateBlocoCommand, BlocoDto>, CreateBlocoCommandHandler>();
        services.AddScoped<ICommandHandler<RenameBlocoCommand, BlocoDto>, RenameBlocoCommandHandler>();
        services.AddScoped<ICommandHandler<InativarBlocoCommand, BlocoDto>, InativarBlocoCommandHandler>();
        services.AddScoped<ICommandHandler<ReativarBlocoCommand, BlocoDto>, ReativarBlocoCommandHandler>();
        services.AddScoped<ICommandHandler<CreateUnidadeCommand, UnidadeDto>, CreateUnidadeCommandHandler>();
        services.AddScoped<ICommandHandler<InativarUnidadeCommand, UnidadeDto>, InativarUnidadeCommandHandler>();
        services.AddScoped<ICommandHandler<ReativarUnidadeCommand, UnidadeDto>, ReativarUnidadeCommandHandler>();
        services.AddScoped<IQueryHandler<GetCondominioDetailsQuery, CondominioDetailsDto>, GetCondominioDetailsQueryHandler>();
        services.AddScoped<IQueryHandler<GetEstruturaQuery, EstruturaDto>, GetEstruturaQueryHandler>();
